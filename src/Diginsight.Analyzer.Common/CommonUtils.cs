...
public static class CommonUtils
{
        ...
        where TKey : notnull
    {
        ...
        {
            IReadOnlyDictionary<TKey, TObj> objectDict = objects.ToDictionary(static x => x.Key, equalityComparer);
            ...
            while (pendingKeys.Any())
            {
                ...
                {
                    if (!objectDict.TryGetValue(pendingKey, out TObj? @object))
                    {
                    ...
                    IEnumerable<TKey> dependencies = @object.Dependencies;
